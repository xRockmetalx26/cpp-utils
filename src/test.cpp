...
int main() {
    std::cout << AES::decrypt(AES::encrypt(std::string{"pene"}, "12345678912345678912345678912345", "1234567891234567"), "12345678912345678912345678912345", "1234567891234567") << std::endl;
